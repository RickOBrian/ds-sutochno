...
import type { ComponentRow, PlatformSheetData, TableColumnDef } from "@/types/component-row";
...
export function BentoTableWidget({ rows, columns, isPlatformEmpty }: BentoTableWidgetProps) {
  return (
    <motion.section
    ...
    >
      <ComponentsTable rows={rows} columns={columns} isPlatformEmpty={isPlatformEmpty} embedded />
    </motion.section>
  );
}
