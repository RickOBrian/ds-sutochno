  ...
  return (
    ...
    >
      <ScrollFadeContainer className="sticky top-8 max-h-[calc(100vh-4rem)] overflow-y-auto pr-1">
        <p className="mb-4 text-xs font-normal tracking-wide text-[var(--rp-prose-meta)]">
          Содержание
        </p>
              ...
              >
                {isTocChapter(section) ? (
                  ...
                  <span className="flex gap-2">
                    <span className="mt-[0.35rem] h-1 w-1 shrink-0 rounded-full bg-[var(--rp-prose-meta)]" aria-hidden />
